...
""" Algebraické operace """
z = x - y         #type: ignore         # Mají-li řady stejný počet prvků, lze s nimi takto jednoduše pracovat
w = x * y
...
""" Náhodné operace """
r = np.random.rand(3, 5) # type: ignore # Matice rozměru 3 x 5 vyplněná náhodnými čísly z rovnoměrného rozdělení na <0, 1) 
